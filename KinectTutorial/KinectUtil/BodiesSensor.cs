namespace KinectTutorial.KinectUtil.Body
{
    using System;
    ...
    class BodiesSensor : IDisposable
    {
        ...
        public delegate void BodyFrameHandler(BodyFrame frame);
        private BodyFrameHandler bodyFrameHandler = null;
        ...
        public BodiesSensor(KinectSensor sensor, Canvas drawableCanvas, int bodyCount, BodyFrameHandler bodyFrameHandler)
        {
            this.frameReader = sensor.OpenMultiSourceFrameReader(FrameSourceTypes.Body);
            ...
            this.bodyFrameHandler = bodyFrameHandler;
        ...
        private void OnFrameArrived(object sender, MultiSourceFrameArrivedEventArgs e)
        {
            ...
            if(multiFrame != null)
            {
                using (BodyFrame bodyFrame = multiFrame.BodyFrameReference.AcquireFrame())
                {
                    if(bodyFrame != null)
                    {
                        this.bodyFrameHandler(bodyFrame);
                    }
                }
            }
